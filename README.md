...
6. **Optional:** To incorporate event summarizations, you have the flexibility to utilize Amazon Sagemaker Language Model (LLM). For this sample, we used huggingface-summarization-bart-large-cnn-samsum model. By providing the model endpoint ARN as user input, you can include this functionality. Please see  ![huggingface-summarization-bart-large-cnn-samsum.md](https://github.com/aws-samples/aws-health-events-insight/blob/main/huggingface-summarization-bart-large-cnn-samsum.md) for more information.
